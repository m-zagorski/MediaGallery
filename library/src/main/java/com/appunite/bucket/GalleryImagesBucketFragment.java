...
import com.appunite.images.presenter.GalleryImagesBucketPresenter;
...
import com.appunite.utils.TransitionManagerCompat;
...
public class GalleryImagesBucketFragment extends BaseFragment {
    ...
    @Inject
    GalleryImagesBucketPresenter presenter;
    ...
    @Nonnull
    static GalleryImagesBucketFragment newInstance(@Nonnull String bucketName) {
        final GalleryImagesBucketFragment fragment = new GalleryImagesBucketFragment();
                ...
                presenter.selectedCountObservable()
                        .subscribe(new Action1<Integer>() {
                            ...
                            public void call(Integer integer) {
                                TransitionManagerCompat.beginDelayedTransition(bottomContainer);
                        ...
                        .subscribe(new Action1<FullscreenData>() {
                            ...
                            public void call(FullscreenData fullscreenData) {
                                final Intent intent = GalleryMediaFullscreenActivity.newIntent(
                                        ...
                                        fullscreenData.currentlySelected(), false);
    ...
    protected void inject(@Nonnull FragmentActivity activity) {
        final Component component = DaggerGalleryImagesBucketFragment_Component.builder()
    ...
    public interface Component {
        void inject(GalleryImagesBucketFragment fragment);
    }
